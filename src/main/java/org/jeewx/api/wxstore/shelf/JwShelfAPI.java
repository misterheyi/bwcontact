...
public class JwShelfAPI {
	...
	public static ShelfRtnInfo doAddExpress(String newAccessToken, Shelf shelf) {
		if (newAccessToken != null) {
			...
			JSONObject result = WxstoreUtils.httpRequest(requestUrl, "POST", JSON.toJSONString(shelf));
			ShelfRtnInfo shelfRtnInfo = JSON.parseObject(result.toJSONString(), ShelfRtnInfo.class);
			return shelfRtnInfo;
		}
		return null;
	}
	...
	public static ShelfRInfo getByShelfId(String newAccessToken, Integer shelf_id) {
		if (newAccessToken != null) {
			...
			shelfRInfo = JSON.parseObject(result.toJSONString(), ShelfRInfo.class);
			return shelfRInfo;
		}
		return null;
	}
