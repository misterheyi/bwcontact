	...
	*/// 批量导入门店信息
	...
	public BatchaddRtn doBatchadd(String accesstoken,Batchadd batchadd) throws WexinReqException {
		if (accesstoken != null) {
			...
			BatchaddRtn batchaddRtn = JSON.parseObject(result.toJSONString(), BatchaddRtn.class);
			return batchaddRtn;
		}
		return null;
	}
	...
	public BatchgetRtn doBatchget(String accesstoken,Batchget batchget) throws WexinReqException{
		if (accesstoken != null) {
			...
			BatchgetRtn batchgetRtn = JSON.parseObject(result.toJSONString(), BatchgetRtn.class);
			return batchgetRtn;
		}
		return null;
	}
	...
	public GetcolorsRtn doGetcolors(String accesstoken) throws WexinReqException {
		if (accesstoken != null) {
			...
			GetcolorsRtn getcolorsRtn = JSON.parseObject(result.toJSONString(), GetcolorsRtn.class);
			return getcolorsRtn;
		}
		return null;
	}
	...
	public CardInfoRtn doAddCard(String accesstoken,CardInfo cardInfo) throws WexinReqException{
		if (accesstoken != null) {
			...
			CardInfoRtn cardInfoRtn = JSON.parseObject(result.toJSONString(),CardInfoRtn.class);
			return cardInfoRtn;
		}
		return null;
	}
